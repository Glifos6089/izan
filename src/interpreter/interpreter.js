...
//---------------------------------------------------------------------------santiquiroz regular expressions ----------------------------------------------------------------
        ...
        if (m !== null) {
            if (guzmanmeter == 0) {
                message.channel.send(" ```fix Ha escrito el nombre del señor oscuro corran!!!! ```");
            }
            else if (guzmanmeter == 1) {
                message.channel.send(" ```fix Esta cerca!!!!! ```");
            }
            else if (guzmanmeter == 2) {
                message.channel.send("```prolog \n No mi PAPA no GUZMAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA \n AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA \n AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAN \n ```");
            }
